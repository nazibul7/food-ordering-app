...
export default function ManageResturantPage() {
  ...
  return (
    <Tabs defaultValue="orders">
      ...
      <TabsContent
        value="orders"
        className="space-y-5 bg-slate-50 p-10 rounded-lg"
      >
        <h2 className="text-2xl font-bold">
          {orderForResturantOwner?.length || 0} active orders
        </h2>
      ...
      <TabsContent value="manage-resturant">
        <ManageResturantForm
          resturant={resturant}
          onSave={resturant?._id ? updateResturant : creatResturant}
